...
const ID _kernel_torder_table[TNUM_STSKID] = {
	LOGTASK, BRICK_BTN_TSK, LCD_REFRESH_TSK, CONSOLE_BTN_TSK, BT_TSK, BT_QOS_TSK, USBMSC_TSK, EV3_INIT_TASK, PLATFORM_BUSY_TASK, EV3RT_LOGTASK, ZMODEM_RECV_TASK
};
...
const ALMINIB _kernel_alminib_table[TNUM_SALMID] = {
	...
	{ (TA_NULL), (intptr_t)(0), (app_ter_btn_alm), { TACP_KERNEL, TACP_KERNEL, TACP_KERNEL, TACP_KERNEL }}
};
